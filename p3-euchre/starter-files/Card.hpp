...
public:
  ...
  Card(Rank rank_in, Suit suit_in); //done

  //EFFECTS Returns the rank
  Rank get_rank() const; //done

  //EFFECTS Returns the suit.  Does not consider trump.
  Suit get_suit() const; //done

  //EFFECTS Returns the suit
  //HINT: the left bower is the trump suit!
  Suit get_suit(Suit trump) const; //done

  //EFFECTS Returns true if card is a face card (Jack, Queen, King or Ace)
  bool is_face_or_ace() const; //done

  //EFFECTS Returns true if card is the Jack of the trump suit
  bool is_right_bower(Suit trump) const; //done

  //EFFECTS Returns true if card is the Jack of the next suit
  bool is_left_bower(Suit trump) const; //done

  //EFFECTS Returns true if the card is a trump card.  All cards of the trump
  // suit are trump cards.  The left bower is also a trump card.
  bool is_trump(Suit trump) const; //done
...
std::ostream & operator<<(std::ostream &os, const Card &card); //done

//EFFECTS Reads a Card from a stream in the format "Two of Spades"
//NOTE The Card class declares this operator>> "friend" function,
//     which means it is allowed to access card.rank and card.suit.
std::istream & operator>>(std::istream &is, Card &card); //done

//EFFECTS Returns true if lhs is lower value than rhs.
//  Does not consider trump.
bool operator<(const Card &lhs, const Card &rhs); //done
...
Suit Suit_next(Suit suit); //done

//EFFECTS Returns true if a is lower value than b.  Uses trump to determine
// order, as described in the spec.
bool Card_less(const Card &a, const Card &b, Suit trump); //done

//EFFECTS Returns true if a is lower value than b.  Uses both the trump suit
//  and the suit led to determine order, as described in the spec.
bool Card_less(const Card &a, const Card &b, const Card &led_card, Suit trump); //done
